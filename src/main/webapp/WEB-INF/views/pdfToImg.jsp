...
<label style="color:white">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h3 class="text-center" style="color: #ffffffe0 !important;">PDF to Image</h3>
            
            <div class="card border-0 shadow-lg mt-4">
                <div class="card-body text-center">
                    <div class="form-group mb-4">
                        <label for="pdfFile" class="form-label" style="color: #003381; font-weight: 500;">Upload PDF File:</label>
                        <input type="file" id="pdfFile" class="form-control" accept="application/pdf">
                    </div>

                    <button class="btn btn-primary" onclick="convertPdfToImg()">Convert PDF to Image</button>
                </div>
            </div>
