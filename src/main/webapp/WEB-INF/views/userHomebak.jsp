...
<html lang="en" >
    <head>
        ...
        <link href="${pageContext.request.contextPath}/resources/css/dark-theme.css" rel="stylesheet" id="themeStylesheet">
...
<section id="header"> 
  ...
  <div  class="navbar navbar-inverse navbar-fixed-top top-nav" style="display:flex; background: #ffffff; padding: 0 3%; border:none !important">
  ...
  <option value="Light">Light</option>
    ...
    <div class="container" style="margin-right:0; display:block">
     <ul id="optionsHome" class="navbar-nav ml-auto" style="margin-top: 1%;list-style-type: none;
    padding: inherit;float:inline-end; font-size:21px;     display: flex;    flex-direction: row;    justify-content: space-between;    width: 50%;">
